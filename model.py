...
data_dir = "/home/zcabmak/Scratch/src/images/cancer_data_test_all"
...
def calculate_accuracy_per_slide(slide_info):
    ...
    for slide_number, info in slide_info.items():
        ...
        if tiles_with_predictions == 0:
            ...
            continue
#        probability = correct_pred/all_seen
...
#        y_classes.extend(preds.cpu().numpy())
...
#   SFT_acc = correct_SFT/all_SFT
#   SS_acc = correct_SS/all_SS
    ...
    time_elapsed = time.time() - since
    #print("The accuracy over all tiles is: {}".format(acc))
    #print("The accuracy for SFT is: {} and for SS is: {}".format(SFT_acc, SS_acc)) 
...
# Train and evaluate
if phase == "test":
    model_ft = torch.load("/home/zcabmak/Scratch/gpu_output_inception_1/model.pt")
    model_ft.eval()
...
#    plt.show()
    plt.savefig('/home/zcabmak/Scratch/inception_latest/roc_{}_all.png'.format(model_name))

#    dist = create_prob_distribution(probs)
#    names = ['x < 0.70', '70 < x < 75', '75 < x < 80', '80 < x < 85', '85 < x < 90', '90 < x < 95', '95 < x < 100']
#    values = [dist[key] for key in dist.keys()]
...
#    plt.savefig('/home/zcabmak/Scratch/dist/dist_{}.png'.format(model_name))
    with open('/home/zcabmak/Scratch/inception_latest/accuracy.txt', 'w') as f:
...
# Save the model
    torch.save(model_ft, "/home/zcabmak/Scratch/inception_latest/model.pt")
    with open('/home/zcabmak/Scratch/inception_latest/history.txt', 'w') as f:
